...
Я уже установил машину когда начал выполнять работы в середине семестра.
У меня нет возможности ее удалить и начинать заново.

Поэтому я покажу машину и папки для лабораторных.

![Мой пользователь](image/01.png){ #fig:001 width=70% height=70% }

![Лабораторные](image/02.png){ #fig:002 width=70% height=70% }
...
![Команда df](image/04.png){ #fig:004 width=70% height=70% }
