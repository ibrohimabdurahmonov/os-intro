...
Я уже создал репозиторий на гитхабе заранее. Там загружены мои отчеты, которые я начал выполнять в середине семестра.

![Репозиторий](image/01.png){ #fig:001 width=70% height=70% }

![Подключение репозитория](image/02.png){ #fig:002 width=70% height=70% }

![Сданные работы](image/03.png){ #fig:003 width=70% height=70% }
